...
export default class FlPrayerRequests extends NavigationMixin(LightningElement) {
    @api eventId;
    @api eventName; // NEW
    ...
    get filteredRequests() {
        ...
        return this.requests.filter(req => {
            // 1. Status Filter
            const matchesStatus = this.filterStatus === 'All' || req.Status__c === this.filterStatus;
            
            // 2. "My" Filter
            const matchesOwner = !this.filterMine || (req.OwnerId === this.currentUserId);
