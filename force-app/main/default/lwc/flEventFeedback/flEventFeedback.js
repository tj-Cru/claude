...
export default class FlEventFeedback extends NavigationMixin(LightningElement) {
    ...
    applyFilters() {
        ...
        let tempResults = this.allRecords.filter(rec => {
            ...
            const valAttendee = rec.AttendeeName ? rec.AttendeeName.toLowerCase() : '';
    ...
    get isTypeSort() { return this.sortedBy === 'Type__c'; }
    get isAttendeeSort() { return this.sortedBy === 'AttendeeName'; }
    get isHouseholdSort() { return this.sortedBy === 'HouseholdName'; }
}